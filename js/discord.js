(function () {
  ...
  function upsertAdminAccountFromDiscordSession(session, accounts) {
    ...
    const discordAvatarUrl =
      toSafeString(session.avatarUrl) || buildDiscordAvatarUrl(discordUserId, toSafeString(session.avatarHash || session.avatar));
    ...
    if (existing) {
      ...
      const previous = JSON.stringify({
        ...
        discordAvatarUrl: existing.discordAvatarUrl,
      ...
      existing.discordAvatarUrl = discordAvatarUrl || toSafeString(existing.discordAvatarUrl);
